...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--gt_mask_folder', default="data/MSD/test/mask", type=str)
    parser.add_argument(
        '--image_path', default="data/MSD/test/image", type=str)
    parser.add_argument(
        '--pred_mask_folder', default="data/MSD/test/pred", type=str)
    parser.add_argument(
        '--save_txt', default="results/test_result.txt", type=str, help="output txt save path")
    parser.add_argument(
        '--sample_save_folder', default="ml_result", \
