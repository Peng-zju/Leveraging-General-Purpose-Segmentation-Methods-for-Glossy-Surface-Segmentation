...
def main():
    ...
    probability_img_save_folder = "/local-scratch/jiaqit/exp/result/mirror_seg_result/mirrorNet_result"
    ...
    with torch.no_grad():
        for name, root in to_test.items():
            ...
            for idx, img_name in enumerate(img_list):
                ...
                # pro_img_save_path = os.path.join(probability_img_save_folder, img_name[:-4] + ".png")
                # cv2.imwrite(pro_img_save_path,np.array(f_1)[0])
                # end
